...
function SmartThermostat() {
  ...
  return (
    <div className='temperature-display'>
      <TemperatureDisplay currentTemperature={temperature} temperatureSetting={temperatureSetting} />
      <TemperatureSetting temperature={temperature} onSave={saveTemperatureSetting} />
...
function TemperatureSetting({ temperature, onSave }) {
  const [newTemperatureSetting, setNewTemperatureSetting] = useState(temperature);
